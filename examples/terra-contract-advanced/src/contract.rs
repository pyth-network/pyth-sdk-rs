...
mod tests {
    ...
    /// motion, and shows how to use `set_price` to feed this price stream into the contract to
    /// test the contract behaviour when dealing with realistic price data.
    ///
    /// See the README for a visual graph of the price action generated by this test.
    #[test]
    pub fn test_stochastic_price_action() {
        ...
        // random number stream and so will always produce consistent test data.
        ...
        // This is the core of our test: we iterate through the 5000 generated points, and pass
        // them to our contract. At the end, we can evaluate how the contract behaved in response
        // to the price action.
        for n in 0..5000 {
            ...
            // price action, you will want to check here if your program breaks during violent
            // rises and drops.
            //
            // See the README for a visual graph of the price action produced by this example test,
            // but be sure to experiment with the input price data yourself to fully test your
            // contract behaviour.
            //
