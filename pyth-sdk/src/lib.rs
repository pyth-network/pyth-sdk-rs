...
impl PriceFeed {
    ...
    ///
    /// Returns the previous aggregate price with the timestamp it was generated. Make sure to check
    /// timestamp when using this price. Please use `get_current_price` where possible.
